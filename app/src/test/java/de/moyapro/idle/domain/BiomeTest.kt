...
internal class BiomeTest {
    ...
    fun speciesCanEatEachOther() {
        val initialResources = Resources(DoubleArray(values().size) { 2000.0 })
    ...
    fun speciesEatsAnotherSpecies() {
        val initialResources = Resources(DoubleArray(values().size) { 300.0 })
    ...
    fun biomeStoresResourcesGeneratedBySpecies() {
        ...
        val species = Species("Flower").evolve(Feature.sunlightConsumer())
